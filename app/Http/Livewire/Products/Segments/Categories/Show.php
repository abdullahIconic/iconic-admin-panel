...
class Show extends Component
{
    ...
    public function delete()
    {
        ...
        return redirect(route('products.segments.categories.index'));
    }
    ...
    public function featureImageToggle($imageId)
    {
        ...
        return redirect(route('products.segments.categories.show', $this->category->id));
    }
    ...
    {
        return view('livewire.products.segments.categories.show')->extends('layouts.panel');
    }
}
