...
use App\Http\Requests\StoreSegmentCategoryRequest;
use App\Http\Requests\UpdateSegmentCategoryRequest;
use Illuminate\Support\Facades\Storage;
use App\Models\ServiceCategory;

class SegmentCategoryController extends Controller
{
    /**
     ...
     *
     * @param  \App\Http\Requests\StoreSegmentCategoryRequest  $request
     * @return \Illuminate\Http\Response
     */
    public function store(StoreSegmentCategoryRequest $request)
    {
     ...
     *
     * @param  \App\Http\Requests\UpdateSegmentCategoryRequest  $request
     * @param  \App\Models\ServiceCategory  $serviceCategory
     * @return \Illuminate\Http\Response
     */
    public function update(UpdateSegmentCategoryRequest $request, ServiceCategory $category)
    {
        $category->update([
            "visible" => $request->visible,
