...
class IndustryCategoryController extends Controller
{
     ...
     *
     * @param  \App\Http\Requests\StoreIndustryCategoryRequest  $request
     * @return \Illuminate\Http\Response
     */
     ...
     *
     * @param  \App\Http\Requests\UpdateIndustryCategoryRequest  $request
     * @param  \App\Models\ServiceCategory  $serviceCategory
     * @return \Illuminate\Http\Response
     */
    public function update(UpdateIndustryCategoryRequest $request, ServiceCategory $category)
    {
        $category->update([
            "visible" => $request->visible,
