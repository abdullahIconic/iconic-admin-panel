...
<form class="body" action="{{ route('lps.cards.store') }}" method="post" enctype="multipart/form-data">
    @csrf
    <div class="row g-3">
        <div class="col-md-2">
        ...
        <div class="col-md-2">
            ...
            <select class="form-control @error('page_name') is-invalid @enderror" name="page_name" required>
        ...
        <div class="col-md-2">
            ...
            <select class="form-control @error('card_for') is-invalid @enderror" name="card_for" required>
        ...
        <div class="col-md-6">
            ...
            <input type="text" class="form-control @error('url') is-invalid @enderror" name="url" id="url" placeholder="https://www.youtube.com/watch?v=t8pPdKYpowI">
            @error('url')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
        ...
        <div class="col-md-12">
            ...
            <textarea type="text" class="form-control @error('overview') is-invalid @enderror" name="overview" id="overview" placeholder="Overview"></textarea>
            @error('overview')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
