...
<form class="body" action="{{ route('service-list.update', $service->id) }}" method="post" enctype="multipart/form-data">
    @method('patch')
    @csrf
    ...
    <div class="row g-3">
        <div class="col-md-1">
            ...
            <select wire:model="service_for" class="form-control @error('service_for') is-invalid @enderror" name="service_for" required>
        ...
        <div class="col-md-3">
            ...
            <input wire:model="identifier" type="text" class="form-control @error('identifier') is-invalid @enderror" name="identifier" id="identifier" placeholder="Identifier" value="{{ old('identifier') }}" required>
            @error('identifier')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
        ...
        <div class="col-12">
            ...
            <textarea wire:model="services" type="text" class="form-control @error('services') is-invalid @enderror" name="services" id="services" placeholder="Separated by (,)">{{ old('services') }}</textarea>
            @error('services')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
        ...
        <div class="col-md-6">
            ...
            <textarea wire:model="caption" type="text" class="form-control @error('caption') is-invalid @enderror" name="caption" id="caption" placeholder="Caption">{{ old('caption') }}</textarea>
            @error('caption')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
