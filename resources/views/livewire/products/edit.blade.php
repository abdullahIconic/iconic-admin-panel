...
<form class="body" action="{{ route('products.update', $product->id) }}" method="post" enctype="multipart/form-data">
    @method('patch')
    @csrf
        ...
        <div class="col-md-12" wire:ignore>
            ...
            <div class="tab-content" id="myPillTabContent">
                <div class="tab-pane fade active show" id="pOverview" role="tabpanel" aria-labelledby="pOverview-tab">
                    <textarea wire:model="overview" class="form-control tinymce" name="overview" id="overviewField" placeholder="Overview">{{ old('overview') }}</textarea>
                </div>
                <div class="tab-pane fade" id="pFeature" role="tabpanel" aria-labelledby="pFeature-tab">
                    <textarea wire:model="features" class="form-control tinymce" name="features" id="featuresField" placeholder="Features">{{ old('features') }}</textarea>
                </div>
                <div class="tab-pane fade" id="pSpec" role="tabpanel" aria-labelledby="pSpec-tab">
                    <textarea wire:model="specifications" class="form-control tinymce" name="specifications" id="specificationsField" placeholder="Specifications">{{ old('specifications') }}</textarea>
                </div>
                <div class="tab-pane fade" id="pIncludes" role="tabpanel" aria-labelledby="pIncludes-tab">
                    <textarea wire:model="includes" class="form-control tinymce" name="includes" id="includesField" placeholder="Includes">{{ old('includes') }}</textarea>
                </div>
                <div class="tab-pane fade" id="pAccessories" role="tabpanel" aria-labelledby="pAccessories-tab">
                    <textarea wire:model="accessories" class="form-control tinymce" name="accessories" id="accessoriesField" placeholder="Accessories">{{ old('accessories') }}</textarea>
                </div>
            </div>
        </div>
        <div class="col-md-12">
