    ...
    <div class="table-responsive-sm">
        ...
        <table class="table table-striped table-bordered align-middle">
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <img height="50" src="{{asset('storage/'.$brand->image)}}" alt="">
                    </td>
                    <td>{{$brand->title}}</td>
                    ...
                    <td>
                        <a href="{{route('products.brands.show', $brand->id)}}" class="btn bg-success text-white">View</a>
                        <a href="{{route('products.brands.edit', $brand->id)}}" class="btn bg-warning">Edit</a>
                        
                        <a href="{{route('products.brands.categories', $brand->id)}}" class="btn bg-dark text-white">
