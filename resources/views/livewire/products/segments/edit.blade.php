...
<form class="body" action="{{ route('products.segments.update', $segment->id) }}" method="post" enctype="multipart/form-data">
    @method('patch')
    @csrf
    <div class="row g-3">
        <div class="col-md-4">
        ...
        <div class="">
            ...
            <textarea wire:model="overview" type="text"
                      class="form-control @error('overview') is-invalid @enderror" name="overview" id="overview"
        ...
        <div class="">
            <label class="form-label" for="solution_overview">Solution Overview</label>
            <textarea wire:model="solution_overview" type="text"
                      class="form-control @error('solution_overview') is-invalid @enderror" name="solution_overview" id="description"
                      placeholder="Solution Overview">{{ old('solution_overview') }}</textarea>
            @error('solution_overview')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
            @enderror
        ...
        <div class="">
            <label class="form-label" for="project_overview">Project Overview</label>
            <textarea wire:model="project_overview" type="text"
                      class="form-control @error('project_overview') is-invalid @enderror" name="project_overview" id="project_overview"
                      placeholder="Project Overview">{{ old('project_overview') }}</textarea>
    ...
    <button wire:loading.remove class="btn btn-dark mt-3 px-5" type="submit">Update</button>
</form>
