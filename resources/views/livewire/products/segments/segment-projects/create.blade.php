...
<form class="body" action="{{ route('products.segments.projects.store') }}" method="post" enctype="multipart/form-data">
    @csrf
    <div class="row g-3">
        <div class="col-md-4">
        ...
        <div class="col-md-3">
            <label class="form-label" for="product_segment_id">Product Segment</label>
