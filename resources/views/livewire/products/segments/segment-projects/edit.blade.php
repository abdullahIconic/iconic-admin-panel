...
'title' => 'Edit' . ' - ' . $title,
'parent' => 'Segment Projects',
'parentRoute' => 'products.segments.projects',
'page' => 'edit',
])
@endsection

<form class="body" action="{{ route('products.segments.projects.update', $project->id) }}" method="post" enctype="multipart/form-data">
    @csrf
    @method('patch')
    <div class="row g-3">
        <div class="col-md-4">
        ...
        <div class="col-md-3">
            <label class="form-label" for="product_segment_id">Industry</label>
            <select wire:model="product_segment_id" class="form-control @error('product_segment_id') is-invalid @enderror" name="product_segment_id" id="product_segment_id" required>
                <option value="">-- Select Segment --</option>
                @foreach($product_segments as $segment)
