...
<form class="body" action="{{ route('products.segments.store') }}" method="post" enctype="multipart/form-data">
    @csrf
    <div class="row g-3">
        <div class="col-md-4">
        ...
        <div class="">
            ...
            <textarea wire:model="solution_overview" type="text"
                      class="form-control @error('solution_overview') is-invalid @enderror" name="solution_overview" id="solution_overview"
