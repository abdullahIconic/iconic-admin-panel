@section('navbar')
    @livewire('layout.navbar', [
        ...
        'parentRoute' => 'products.segments.categories',
        'page' => 'edit',
    ])
@endsection

<form class="body" action="{{ route('products.segments.categories.update', $category->id) }}" method="post" enctype="multipart/form-data">
    @method('patch')
    @csrf
    ...
    <div class="row g-3">
        ...
        <div class="">
            ...
            <textarea wire:model="solution_overview" type="text" class="form-control @error('solution_overview') is-invalid @enderror" name="solution_overview" id="solution_overview" placeholder="Solution Overview">{{ old('solution_overview') }}</textarea>
        ...
        <div class="">
            ...
            <textarea wire:model="project_overview" type="text" class="form-control @error('project_overview') is-invalid @enderror" name="project_overview" id="project_overview" placeholder="Project Overview">{{ old('project_overview') }}</textarea>
