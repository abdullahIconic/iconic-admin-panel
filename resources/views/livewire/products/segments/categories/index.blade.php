        ...
        <table class="table table-striped table-bordered align-middle">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{route('products.segments.categories.show', $category->id)}}" class="btn bg-success text-white">View</a>
                        <a href="{{route('products.segments.categories.edit', $category->id)}}" class="btn bg-warning">Edit</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
