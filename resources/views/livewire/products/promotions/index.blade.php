...
<div>
    <div class="mb-3">
        Total {{ $totalPromotions }} Promotions
    </div>
    <div class="table-responsive-sm">
        ...
        <table class="table table-striped table-bordered align-middle">
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <img height="50" src="{{asset('storage/'.$promotion->image_small)}}" alt="">
                    </td>
                    <td>{{$promotion->title}}</td>
                    <td>{{$promotion->visible ? "Yes" : "No"}}</td>
                    <td>
                        <a href="{{route('products.promotions.show', $promotion->id)}}" class="btn bg-success text-white">View</a>
                        <a href="{{route('products.promotions.edit', $promotion->id)}}" class="btn bg-warning">Edit</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
