...
<form action="{{ route('industries.update', $industry->id) }}" class="body" enctype="multipart/form-data" method="post">
    @method('patch')
    @csrf
    ...
    <div class="row g-3">
        ...
        <div class="col-md-12">
            ...
            <input class="form-control @error('image') is-invalid @enderror" id="image" name="image" type="file" wire:model="image">
            @error('image')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
    ...
    <button class="btn btn-dark mt-3 px-5" type="submit" wire:loading.remove>Update</button>
</form>
