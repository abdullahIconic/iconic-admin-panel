...
<div>
    <div class="mb-3">
        Total {{ $totalIndustryProjects }} Industry Projects
    </div>
        ...
        <table class="table table-striped table-bordered align-middle">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$project->title}}</td>
                    <td>{{$project->industry ? $project->industry->title : 'N/A' }}</td>
                    <td>{{$project->visible ? "Yes" : "No"}}</td>
                    <td>
                        <a href="{{route('industries.projects.show', $project->id)}}"
                            class="btn bg-success text-white">View</a>
                        <a href="{{route('industries.projects.edit', $project->id)}}" class="btn bg-warning">Edit</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
