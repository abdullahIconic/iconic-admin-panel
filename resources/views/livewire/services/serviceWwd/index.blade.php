    ...
    <div class="table-responsive-sm">
        ...
        <table class="table table-striped table-bordered align-middle">
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <img height="50" src="{{asset('storage/'.$work->image_small)}}" alt="">
                    </td>
                    <td>{{$work->title}}</td>
                    <td>{{$work->visible ? "Yes" : "No"}}</td>
                    <td>
                        <a href="{{route('services.what-we-delivered.show', $work->id)}}" class="btn bg-success text-white">View</a>
                        <a href="{{route('services.what-we-delivered.edit', $work->id)}}" class="btn bg-warning">Edit</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
