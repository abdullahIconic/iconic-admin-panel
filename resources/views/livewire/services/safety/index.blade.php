        ...
        <table class="table table-striped table-bordered align-middle">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{route('services.safety.show', $safety->id)}}" class="btn bg-success text-white">View</a>
                        <a href="{{route('services.safety.edit', $safety->id)}}" class="btn bg-warning">Edit</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
        </table>
        @if( method_exists($safeties,'links') )
            {{ $safeties->links() }}
        @endif
    </div>
</div>