    ...
    <div class="table-responsive-sm">
        ...
        <table class="table table-striped table-bordered align-middle">
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <img height="50" src="{{asset('storage/'.$offer->image_small)}}" alt="">
                    </td>
                    <td>{{$offer->title}}</td>
                    <td>{{$offer->visible ? "Yes" : "No"}}</td>
                    <td>
                        <a href="{{route('offers.show', $offer->id)}}" class="btn bg-success text-white">View</a>
                        <a href="{{route('offers.edit', $offer->id)}}" class="btn bg-warning">Edit</a>
                        <a href="{{route('offers.products', $offer->id)}}" class="btn bg-dark text-white">
