...
<form wire:submit.prevent="update" class="body">
    <div class="row g-3">
        ...
        <div class="col-md-4">
            ...
            <input wire:model="page_name" type="text" class="form-control @error('page_name') is-invalid @enderror" name="page_name" id="page_name" placeholder="Page Name" value="{{ old('page_name') }}" required readonly>
            @error('visible')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
