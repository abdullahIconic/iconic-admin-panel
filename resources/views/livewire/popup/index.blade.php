    ...
    <div class="table-responsive-sm">
        ...
        <table class="table table-striped table-bordered align-middle">
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <img height="50" src="{{asset('storage/'.$popup->image_small)}}" alt="">
                    </td>
                    <td>{{$popup->title}}</td>
                    <td>{{$popup->visible ? "Yes" : "No"}}</td>
                    <td>
                        <a href="{{route('popup.show', $popup->id)}}" class="btn bg-success text-white">View</a>
                        <a href="{{route('popup.edit', $popup->id)}}" class="btn bg-warning">Edit</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
