...
<form class="body" action="{{ route('careers.update', $career->id) }}" method="post" enctype="multipart/form-data">
    @csrf
    @method('patch')
    ...
    <div class="row g-3">
        ...
        <div class="col-md-12">
            ...
            <textarea wire:model="meta_description" class="form-control" name="meta_description" placeholder="Meta Description">{{ old('meta_description') }}</textarea>
        ...
        <div class="col-md-5">
           ...
           <div class="col-md-12" wire:ignore>
            ...
            <textarea wire:model="description" class="form-control tinymce" name="description" placeholder="Description">{{ old('description') }}</textarea>
            @error('description')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
