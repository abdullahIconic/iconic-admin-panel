        ...
        <table class="table table-striped table-bordered align-middle">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$category->solutions->count()}}</td>
                    <td>
                        <a href="{{route('solutions.categories.show', $category->id)}}" class="btn bg-success text-white">View</a>
                        <a href="{{route('solutions.categories.edit', $category->id)}}" class="btn bg-warning">Edit</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
