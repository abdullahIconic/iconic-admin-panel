        ...
        <table class="table table-striped table-bordered align-middle">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{route('solutions.solution-items.show', $solution->id)}}" class="btn bg-success text-white">View</a>
                        <a href="{{route('solutions.solution-items.edit', $solution->id)}}" class="btn bg-warning">Edit</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
