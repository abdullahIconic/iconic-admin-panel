...
<form class="body" action="{{ route('solutions.update', $solution->id) }}" method="post" enctype="multipart/form-data">
    @method('patch')
    @csrf
    ...
    <div class="row g-3">
        ...
        <div class="col-md-4">
            ...
            <select wire:model="category" class="form-control @error('category') is-invalid @enderror" name="category_id" id="category" required>
