...
<div>
    <div class="mb-3">
        Total {{ $totalSolutions }} Solution(s)
    </div>
        ...
        <table class="table table-striped table-bordered align-middle">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{route('solutions.show', $solution->id)}}" class="btn bg-success text-white">View</a>
                        <a href="{{route('solutions.edit', $solution->id)}}" class="btn bg-warning">Edit</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
