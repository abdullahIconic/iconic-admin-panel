...
<form class="body" action="{{ route('sliders.update', $slider->id) }}" method="post" enctype="multipart/form-data">
    @csrf
    @method('patch')
    ...
    <div class="row g-3">
        ...
        <div class="col-md-4">
            ...
            <input wire:model="segment_slug" type="text" class="form-control" name="segment_slug" placeholder="Segment Slug">
            @error('segment_slug')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
