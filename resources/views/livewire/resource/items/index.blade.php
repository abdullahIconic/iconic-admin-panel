        ...
        <table class="table table-striped table-bordered align-middle">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{route('resource.items.show', $item->id)}}" class="btn bg-success text-white">View</a>
                        <a href="{{route('resource.items.edit', $item->id)}}" class="btn bg-warning">Edit</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
